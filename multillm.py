...
class ChatInterface:
    ...
    def on_chat(self, event=None):
        ...
        synthesis_input = (
            ...
            "\n\nPlease synthesize the strongest final response using the best elements of each. Clean up the text into a single concise passage. Make sure it is written as scientifically as possible."
        )
